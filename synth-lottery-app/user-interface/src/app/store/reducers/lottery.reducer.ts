...
export const loadCurrentContractAllowance = createAction('[Lottery] Load Current Contract Allowance', props<{ accountAddress: string }>());
...
export const reducer = createReducer(
  ...
  on(loadCurrentContractAllowanceSuccess, (state, { contractAllowance }) => {
    return ({ ...state, lotteryAllowance: contractAllowance });
  }),
  on(loadUserBalanceSuccess, (state, { userBalance }) => {
